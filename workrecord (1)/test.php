    ...
    <div class="container">
        <div class="form-container">
            <form id="update" method="post" action="process.php">
                ...
                $sql = "SELECT DISTINCT emp_info.emp_no, position_tb.position_name, position_tb.posi_id, employee_tb.emp_name, dept_tb.dept_name, dept_tb.dept_no, employee_tb.emp_type, emp_info.county, emp_info.card_id, emp_info.province, employee_tb.email_emp, position_tb.position_abb, employee_tb.e_password
                            FROM employee_tb
                            JOIN emp_info using (emp_no)
                            JOIN position_tb using (posi_id)
                            JOIN dept_tb using (dept_no) WHERE employee_tb.emp_no = '" . $empno_update . "'";
